    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="row footer__top">
          {/* Address */}
          <div className="col-12 col-md-4 footer__section footer__address">
            <h2>Address</h2>
            ...
            <p><img src="/images/icons/mail-icon.png" alt="Email" width="20" /> info@freshly.at</p>
          </div>

          {/* Socials */}
          <div className="col-12 col-md-4 footer__section footer__social">
            <h2>Social Links</h2>
          ...
          {/* Newsletter */}
          <div className="col-12 col-md-4 footer__section footer__newsletter">
            <h2>Newsletter</h2>
